...
const cardList = [
    ...
    new Card("Pompeii worm", "Normally the pompeii worm's tail can be found resting in water up to 200 degrees farenheit!", "Alvinella pompejanaconcolor", "5 in.", "unknown", "Hydrothermal vents", "The pompeii worm is known as an extremophile, meaning that it thrives in extreme conditions.", "pompeii_worm.jpeg", "Pompeii worm", "red"),
